  ...
  const steps = [
    {
      ...
      description:
        'Agencies are shared encironments where you and your team can manage all your properties and clients.',
      content: (
        ...
        <div className='mt-6'>
          <label className="block mb-2 text-sm font-medium">Agency URL:</label>
          <input
            type="text"
            className="border border-[#C0D8F3] p-2 rounded w-full"
        ...
        <div className='mt-6'>
          <label className="block mb-2 text-sm font-medium">How large is yout team size</label>
          <select name="" id="" className=' border border-[#C0D8F3] p-2 rounded w-full'>
    ...
    <div className="max-w-7xl  mt-10 layout">
      ...
      <div className="md:flex  justify-between md:items-center mb-8 p-4 pt-28 md:pt-0  rounded-lg">
        <div className="lg:w-2/3 md:w-3/5">
          ...
          <p className="text-gray leading-loose">
            Haven provides you with an agent's dashboard which consists of the set of
            tools you'll need to reach the mass market and sell your properties on our
            platform. Create your agency profile, post properties, promote your
      ...
      <div className="flex flex-col md:flex-row p-6 rounded-lg">
        ...
        <div className="relative w-full md:w-1/3 pr-4">
          ...
          <div
            className="absolute top-0 left-0 w-1 bg-primary transition-all duration-500"
